...
public class RefillEdit extends Activity {

	private final int PICK_1 = 1;

	private Database data = Database.getInstance();

	private Date refillTime = data.refillTime;
	
	@SuppressWarnings("deprecation")
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.refill_edit);
		...
		Button btnDate = (Button) findViewById(R.id.refill_pick1);
		...
		case PICK_1:
			DatePickerDialog.OnDateSetListener dateListener = new DatePickerDialog.OnDateSetListener() {
				...
				public void onDateSet(DatePicker datePicker, int year,
					...
					EditText editText = (EditText) findViewById(R.id.refill);
	...
	public void onSubmitClick(View view) {
		...
		EditText e1 = (EditText) findViewById(R.id.refill);
	...
	public void NextActivity() {
		...
		userLog.put("from", "RefillEdit");
		userLog.put("to", "MainActivity");
		userLog.saveInBackground();

		Intent intent = new Intent();
		intent.setClass(RefillEdit.this, MainActivity.class);
